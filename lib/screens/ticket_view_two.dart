            ...
            Container(
              ...
              child: Column(
                children: [
                  Row(
                    children: [
                      Text("MXP", style: Styles.headLineStyle3.copyWith(color: Colors.white),),
                      const Spacer(),
                      ThickContainer(),
                      ...
                      ThickContainer(),
                      const Spacer(),
                      Text("AMS", style: Styles.headLineStyle3.copyWith(color:Colors.white ),)
                    ],
                  )
                ,
                SizedBox(height: 2,),
                Row(
                  ...
                  children: [
                    SizedBox(
                      width: 100,
                      child: Text("Milan", style: Styles.headLineStyle4.copyWith(color: Colors.white),),
                    ),
                    Text("1H 45M", style: Styles.headLineStyle4.copyWith(color: Colors.white),),
                     SizedBox(
                      width: 100,
                      child: Text("Amsterdam", style: Styles.headLineStyle4.copyWith(color: Colors.white), textAlign: TextAlign.end,),
                    ),
                  ],
                )
                ],
             ...
             decoration: BoxDecoration(
              ...
              child: Column(
                children: [
                  Row(
                    children: [
                      Text("22 July", style: Styles.headLineStyle3.copyWith(color: Colors.white),),
                      const Spacer(),
                      
                      Expanded(child: Center(
                        
                        child: Text("3:00 PM", style: Styles.headLineStyle4.copyWith(color: Colors.white,),),
                      )),
                      SizedBox(width: 24,),                
                      const Spacer(),
                      Text("11", style: Styles.headLineStyle3.copyWith(color:Colors.white ),)
                    ],
                  )
                ,
                SizedBox(height: 2,),
